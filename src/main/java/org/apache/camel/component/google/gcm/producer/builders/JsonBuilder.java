...
public class JsonBuilder extends AbstractBuilder {
    ...
    protected JsonBuilder addNotification() {
      ...
      setJsonField(JSON_NOTIFICATION_TITLE,this.message.getNotification().getTitle(), notificationMap);
      ...
      setJsonField(JSON_NOTIFICATION_SOUND,this.message.getNotification().getSound(), notificationMap);
      setJsonField(JSON_NOTIFICATION_BADGE,this.message.getNotification().getBadge(), notificationMap);
      setJsonField(JSON_NOTIFICATION_TAG,this.message.getNotification().getTag(), notificationMap);
      setJsonField(JSON_NOTIFICATION_COLOR,this.message.getNotification().getColor(), notificationMap);
      setJsonField(JSON_NOTIFICATION_CLICK_ACTION,this.message.getNotification().getClickAction(), notificationMap);
      setJsonField(JSON_NOTIFICATION_BODY_LOC_KEY,this.message.getNotification().getBodyLocKey(), notificationMap);
      setJsonField(JSON_NOTIFICATION_BODY_LOC_ARGS,this.message.getNotification().getBodyLocArgs(), notificationMap);
      setJsonField(JSON_NOTIFICATION_TITLE_LOC_KEY,this.message.getNotification().getTitleLocKey(), notificationMap);
      setJsonField(JSON_NOTIFICATION_TITLE_LOC_ARGS,this.message.getNotification().getTitleLocArgs(), notificationMap);
    ...
    private void setJsonField(String field, Object value,Map<Object, 
                              Object> destination) {
    if (value != null) {
